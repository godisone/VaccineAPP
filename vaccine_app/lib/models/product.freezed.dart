...
class _$ProductTearOff {
  ...
  _Product call(
      ...
      required num? qtyAvailable,
      required bool? isPresReq,
...
mixin _$Product {
  ...
  num? get qtyAvailable => throw _privateConstructorUsedError;
  bool? get isPresReq => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      qtyAvailable: qtyAvailable == freezed
          ...
          : qtyAvailable // ignore: cast_nullable_to_non_nullable
              as num?,
      isPresReq: isPresReq == freezed
          ? _value.isPresReq
          : isPresReq // ignore: cast_nullable_to_non_nullable
              as bool?,
...
class _$_Product implements _Product {
  ...
  @override
  final bool? isPresReq;
  @override
  final List<String>? relatedProducts;

  @override
  String toString() {
    return 'Product(productName: $productName, category: $category, productShortDescription: $productShortDescription, productPrice: $productPrice, productSalePrice: $productSalePrice, productImage: $productImage, productSKU: $productSKU, productType: $productType, stockStatus: $stockStatus, productId: $productId, qtyAvailable: $qtyAvailable, isPresReq: $isPresReq, relatedProducts: $relatedProducts)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other.isPresReq, isPresReq) &&
            const DeepCollectionEquality()
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(isPresReq),
...
abstract class _Product implements Product {
  factory _Product(
      ...
      required num? qtyAvailable,
      required bool? isPresReq,
      List<String>? relatedProducts}) = _$_Product;
